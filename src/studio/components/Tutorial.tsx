...
const STEPS = [
  ...
  {
    title: '4. 왼손 / 오른손 기능',
    body: '왼손은 재생·볼륨(엄지+검지=재생/일시정지, 엄지+중지=볼륨업, 엄지+약지=볼륨다운)을 담당합니다. 오른손은 이펙트(엄지+검지=페이저, 엄지+중지=플랜저, 엄지+약지=디스토션, 엄지+소지=필터)를 담당합니다. 디스토션과 필터는 플랜저처럼 손을 놓아도 값이 그대로 유지되니, 다시 핀치해서 이어서 조절하면 됩니다.',
  },
  {
    title: '5. 오디오 선택 후 시작',

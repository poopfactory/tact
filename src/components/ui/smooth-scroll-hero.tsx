...
> = ({
	...
	// At scroll 0 the clipped box is still small (initialClipPercentage), so
	// it reads as a bare little rectangle sitting in the hero before the
	// user has scrolled at all. Fading it in from 0 opacity over the same
	// [0, scrollHeight] range as the clip-path reveal means it's invisible
	// at rest and only appears as part of the scroll-driven expand.
	const opacity = useTransform(scrollY, [0, scrollHeight], [0, 1]);
